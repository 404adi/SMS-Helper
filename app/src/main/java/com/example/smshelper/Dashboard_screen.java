...
public class Dashboard_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (logoMain.logomain.network_conn.equals("yes")) {
                ...
                public void onClick(View v) {
                    ...
                    yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            editor_mpin.putString(logoMain.logomain.c_mpin, "");
                            editor_mpin.apply();
                            ...
                            editor_getin.putString(logoMain.logomain.getin, "");
                            editor_getin.apply();
                            ...
                            editor_check_m_pass.putString(logoMain.logomain.c_m_pass, "");
            ...
            logoMain.logomain.getmobb = prefs_mob.getString(logoMain.logomain.getmob, "");
