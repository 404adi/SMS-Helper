...
public class loginmpinenter extends AppCompatActivity implements View.OnClickListener {
    ...
    private void matchPassCode() {
        if (getPassCode().equals(passCode)) {
            ...
            editor_mpin.putString(logoMain.logomain.c_mpin, "true");
            editor_mpin.apply();
            ...
            editor_getin.putString(logoMain.logomain.getin, "true");
            editor_getin.apply();
            ...
            editor_check_m_pass.putString(logoMain.logomain.c_m_pass, passCode);
            ...
            eprefs_mob.putString(logoMain.logomain.getmob, mobnotxtinmob);
            eprefs_mob.apply();
