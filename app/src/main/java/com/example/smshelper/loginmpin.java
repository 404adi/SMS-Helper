...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        lSec = getIntent().getStringExtra("security");
    }
            ...
            switch (numbers_list.size()) {
                ...
                case 4:
                    ...
                    if (getPassCode().length() == 0) {
                        ...
                        Intent intent = new Intent(getApplicationContext(),loginmpinenter.class);
                        intent.putExtra("m-pin", Arrays.toString(passCode.getBytes()));
                        intent.putExtra("security", lSec);
                        startActivity(intent);
                        finish();
//                        startActivity(new Intent(this, timepass.class));
                    } else {
                        matchPassCode();
                    }
                    break;
    ...
    private void matchPassCode() {
        if (getPassCode().equals(passCode)) {
            Intent i = new Intent(this, loginmpinenter.class);
            i.putExtra("security",lSec);
            startActivity(i);
            finish();
        } else {
